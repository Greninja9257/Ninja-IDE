...
const base = {
    ...
    resolve: {
        ...
        alias: {
            ...
            // @turbowarp/packager ships only its Node build; see the shim.
            'fs$': path.resolve(__dirname, 'src/lib/ninja-fs-shim'),
    ...
    plugins: [
        new CopyWebpackPlugin({
            patterns: [
                {
                    // @turbowarp/packager fetches its runtime at package time
                    // from a path relative to the page, so it has to be served
                    // alongside the editor.
                    from: 'node_modules/@turbowarp/packager/dist/scaffolding',
                    to: 'scaffolding'
                },
                {
                    // ...and reads its default app icon the same way.
                    from: 'node_modules/@turbowarp/packager/dist/*.png',
                    to: '[name].[ext]'
                },
                {
    ...
    defaultsDeep({}, base, {
        ...
        plugins: base.plugins.concat([
            ...
            new HtmlWebpackPlugin({
                ...
                title: `${APP_NAME} - Think like a Ninja. Code like a Pro.`,
                isEditor: true,
