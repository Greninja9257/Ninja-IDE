...
/* generated l10n code */Scratch.translate.setup({"fi":{"_Add a Webhook":"Lisää webhook","_Delete a Webhook":"Poista webhook","_Enter Webhook URL:":"Anna webhookin URL-osoite:","_Enter Webhook name:":"Anna webhookin nimi:","_Invalid URL! Please make sure you provide a valid URL.":"URL-osoite on virheellinen! Varmista, että antamasi URL-osoite on oikea.","_Please enter a name with at least one character!":"Nimessä on oltava vähintään yksi merkki!","_This Webhook already exists! Please try a different name.":"Tämän niminen webhook on jo käytössä! Valitse jokin muu nimi.","_This Webhook does not exist. Please enter a valid webhook name.":"Tätä webhookia ei ole olemassa. Anna kelvollinen webhookin nimi.","_Webhooks":"Webhookit","_data of [WEBHOOK]":"webhookin [WEBHOOK] tiedot","_send data to [WEBHOOK]":"lähetä tiedot webhookille [WEBHOOK]","_set data of [WEBHOOK] to [JSON] and type to [TYPE]":"aseta webhookin [WEBHOOK] tiedoiksi [JSON] ja tyypiksi [TYPE]"},"it":{"_Add a Webhook":"Aggiungi un Webhook","_Delete a Webhook":"Rimuovi un Webhook","_Enter Webhook URL:":"Inserisci URL del Webhook:","_Enter Webhook name:":"Inserisci nome Webhook:","_Invalid URL! Please make sure you provide a valid URL.":"URL non valido. Verifica di aver inserito un URL valido.","_Please enter a name with at least one character!":"Inserisci un nome formato da almeno un carattere!","_This Webhook already exists! Please try a different name.":"Questo Webhook esiste già. Inserisci un nome diverso.","_This Webhook does not exist. Please enter a valid webhook name.":"Questo Webhook non esiste. Inserisci un nome di Webhook valido.","_Webhooks":"Webhook","_data of [WEBHOOK]":"dati di [WEBHOOK]","_send data to [WEBHOOK]":"invia dati a [WEBHOOK]","_set data of [WEBHOOK] to [JSON] and type to [TYPE]":"porta i dati di [WEBHOOK] a [JSON] con tipo [TYPE]"},"ja":{"_Add a Webhook":"Webhookを追加する","_Delete a Webhook":"Webhookを削除する","_Enter Webhook URL:":"WebhookのURLを入力してください。","_Enter Webhook name:":"Webhookの名前を入力してください。","_Invalid URL! Please make sure you provide a valid URL.":"URLが無効です。有効なURLを入力してください。","_Please enter a name with at least one character!":"名前は一文字以上にしてください。","_This Webhook already exists! Please try a different name.":"このWebhookは既に存在します。別の名前をお試しください。","_This Webhook does not exist. Please enter a valid webhook name.":"このWebhookは存在しません。有効なWebhook名を入力してください。"},"ko":{"_Webhooks":"웹 훅"},"ru":{"_Add a Webhook":"Добавить Вебхук","_Delete a Webhook":"Удалить Вебхук","_Enter Webhook URL:":"Введите URL Вебхука:","_Enter Webhook name:":"Введите имя Вебхука:","_Invalid URL! Please make sure you provide a valid URL.":"Невалидный URL! Пожалуйста, убедитесь то, что вы предоставили корректный URL.","_Please enter a name with at least one character!":"Пожалуйста, введите имя хотя бы с одним символом!","_This Webhook already exists! Please try a different name.":"Такой же Вебхук уже существует! Пожалуйста, попробуйте другое имя.","_This Webhook does not exist. Please enter a valid webhook name.":"Такого Вебхука не существует. Пожалуйста, введите корректное имя вебхука.","_Webhooks":"Вебхуки","_data of [WEBHOOK]":"данные от [WEBHOOK]","_send data to [WEBHOOK]":"отправить данные на [WEBHOOK]","_set data of [WEBHOOK] to [JSON] and type to [TYPE]":"задать данные от [WEBHOOK] на [JSON] и тип[TYPE]"},"zh-cn":{"_Add a Webhook":"添加 Webhook","_Delete a Webhook":"删除 Webhook","_Enter Webhook URL:":"输入 Webhook URL：","_Enter Webhook name:":"输入 Webhook 名称：","_Invalid URL! Please make sure you provide a valid URL.":"URL 无效！请确保你提供的是有效 URL。","_Please enter a name with at least one character!":"请输入至少一个字符的名称！","_This Webhook already exists! Please try a different name.":"此 Webhook 已存在！请尝试其他名称。","_This Webhook does not exist. Please enter a valid webhook name.":"此 Webhook 不存在。请输入一个有效 Webhook 名称。","_data of [WEBHOOK]":"[WEBHOOK]的数据","_send data to [WEBHOOK]":"发送数据到[WEBHOOK]","_set data of [WEBHOOK] to [JSON] and type to [TYPE]":"将[WEBHOOK]的数据设为[JSON]，类型设为[TYPE]"}});/* end generated l10n code */(function (Scratch) {
  "use strict";
