 ...
 */
const bundledExtensionRoot = new URL(`${process.env.ROOT}ninja-extensions/`, location.href).href;

const isTrustedExtension = url => (
    // Always trust our official extension repostiory.
    url.startsWith('https://extensions.turbowarp.org/') ||

    // Extensions vendored into Ninja's own build.
    url.startsWith(bundledExtensionRoot) ||
