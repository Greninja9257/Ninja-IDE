...
import neuralNetworksIconURL from './neuralNetworks/neural-networks.svg';
import neuralNetworksInsetIconURL from './neuralNetworks/neural-networks-small.svg';
...
export default [
    ...
    },
    {
        name: (
            <FormattedMessage
                defaultMessage="Neural Networks"
                description="Name for the 'Neural Networks' extension"
                id="ninja.extension.neuralNetworks.name"
            />
        ),
        extensionId: 'neuralnetworks',
        iconURL: neuralNetworksIconURL,
        insetIconURL: neuralNetworksInsetIconURL,
        description: (
            <FormattedMessage
                defaultMessage="Train neural networks on lists and the camera."
                description="Description for the 'Neural Networks' extension"
                id="ninja.extension.neuralNetworks.description"
            />
        ),
