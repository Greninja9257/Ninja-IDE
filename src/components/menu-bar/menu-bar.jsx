...
import {openNinjaExportModal, openTipsLibrary, openRestorePointModal} from '../../reducers/modals';
...
class MenuBar extends React.Component {
    ...
    handleToggleWarpTimer () {
        this.props.vm.setCompilerOptions({warpTimer: !this.props.warpTimer});
        this.props.onRequestCloseEdit();
    }
                                    ...
                                    <MenuSection>
                                        <MenuItem onClick={this.handleClickExport}>
                                            <FormattedMessage
                                                ...
                                                description="Menu item to package the project for other platforms"
                                                id="ninja.menuBar.export"
                                            />
                                        </MenuItem>
                                    </MenuSection>
                                    <MenuSection>
                        ...
                        >
                            ...
                            >
                                ...
                                <MenuSection>
                                    ...
                                    <MenuItem onClick={this.handleToggleWarpTimer}>
                                        {this.props.warpTimer ? 'Turn off Warp Timer' : 'Turn on Warp Timer'}
                                    </MenuItem>
                                    <MenuItem onClick={this.handleToggleInterpolation}>
                                        {this.props.interpolation ? 'Turn off Interpolation' : 'Turn on Interpolation'}
                                    </MenuItem>
                                </MenuSection>
                            </MenuBarMenu>
                        </MenuLabel>
