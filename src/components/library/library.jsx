...
class LibraryComponent extends React.Component {
    ...
    getFilteredData () {
        ...
        // Searching and tag filtering preserve catalog order. Favorites are a
        // convenience section, not a relevance signal.
        let filteredItems = this.props.data.filter(dataItem => dataItem !== '---');
